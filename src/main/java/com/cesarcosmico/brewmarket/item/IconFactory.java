package com.cesarcosmico.brewmarket.item;

import com.cesarcosmico.brewmarket.config.IconConfig;
import com.cesarcosmico.brewmarket.item.component.ComponentRegistry;
...
public class IconFactory {
    ...
    public IconConfig parseIconConfig(ConfigurationSection section) {
        if (section == null) {
            return new IconConfig(new ItemStack(Material.BARRIER), null, null, List.of(), " ");
        }
        ...
        if (actionSection != null) {
            for (String actionKey : actionSection.getKeys(false)) {
                ...
                if ("sound".equals(type)) {
                    ...
                    message = action.getString("value", "");
                }
            }
        }

        return new IconConfig(baseItem, sound, message, loreRaw, displayNameRaw);
    }
